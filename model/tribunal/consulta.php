...
$result_pg = "SELECT COUNT(id) AS num_result FROM tribunal";
$resultado_pg = mysqli_query($conn, $result_pg);
$qnt_linhas = mysqli_fetch_assoc($resultado_pg);

$result_clientes = "SELECT id, nome FROM tribunal WHERE tribunal.escritorio_id = $id";
...
while ($row_clientes = mysqli_fetch_array($resultado_clientes)) {
    ...
    $btn_excluir = "<button type='button' class='btn btn-danger ml-3'><i class='fas fa-trash-alt'></i>";
